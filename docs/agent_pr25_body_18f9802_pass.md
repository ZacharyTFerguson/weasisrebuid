...
**HEAD:** `18f9802` (`Add ImageTool AutoLevels chrome that stretches min/max via AutoLevelsOp.`). **Flip** `004f59d`, **Sharpen** `3844bd4`, **Window** `3091f5e`, **Crop** `f88ec68`, and **Brightness** `e9ef165` headed PASS (prior chrome not re-scored). **AutoLevels** `18f9802` headed PASS (identity on Reed chest 0–255). **Next:** Mask/Shutter — **not** Pass. Full TUTORIALS.md walkthrough is still **not** Pass.
...
| **`autolevels` / AutoLevels** on Image chrome | **OK** — `1065,470,109×25`; **brightness** `954,470,107×25`; **flip** `1178,470,56×25` |
