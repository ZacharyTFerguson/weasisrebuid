...
|---|---|---|---|
| GUI overview / prefs | 0–1 | Felix + dummy viewer; `WeasisWin` title `Weasis v4.7.3`; Help>Keyboard Shortcuts live map; Help>System resources; Help>About; `ToolBarContainer` Viewer/Zoom/Rotation/Screenshot; File>Import DICOM | headed UI |
