...
| DICOM 2D / LUT / Zoom | 4 | W/L paints; zoom −200/−100; screenshot PNG/JPEG; T/W/S/Z/R/C/Q/P keys; series/image nav; Ctrl-drag accelerate | tutorial |
...
| MPR / CPR / MIP | 7 | isotropic axes, MIP types; MPR Alt+X/C/V and Ctrl+Alt+B / Alt+wheel | tutorial |
