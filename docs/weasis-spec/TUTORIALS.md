...
| Q/R, DICOMweb, send, ISO, print | 11 | DIMSE/QIDO/STOW Have tests; Q/R import chrome; send C-STORE/STOW chrome; `AbstractDicomNode` `DCM4CHEE:11112`; `DicomNodeListView` / `DicomNodePrefFactory` | tutorial |
