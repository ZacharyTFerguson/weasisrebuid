...
| 11 | QR C-FIND/MOVE/GET, WADO, QIDO/STOW, send, ISO, print | network Have tests; XML/JSON WADO manifest + WADO-RS retrieve + MX-10/11 caps; DICOM Print dialog film-session Have |
