...
**HEAD:** `0d2f39f` (`Show DcmHeader Dump of the painted View2d dataset in a live text pane.`). **Flip** `004f59d`, **Sharpen** `3844bd4`, **Window** `3091f5e`, **Crop** `f88ec68`, **Brightness** `e9ef165`, **AutoLevels** `18f9802`, **Mask** `3355cda`, and **Shutter** `b00cd4d` headed PASS (ImageTool 2D chrome not re-scored). **DcmHeader Dump** `0d2f39f` headed PASS. Full TUTORIALS.md walkthrough still **not** Pass. Full TUTORIALS.md walkthrough is still **not** Pass.
