...
**HEAD:** `363f172` (`Show File/toolbar Export DICOM of the explorer series in a live dialog.`). **Flip** `004f59d`, **Sharpen** `3844bd4`, **Window** `3091f5e`, **Crop** `f88ec68`, **Brightness** `e9ef165`, **AutoLevels** `18f9802`, **Mask** `3355cda`, **Shutter** `b00cd4d`, **DcmHeader Dump** `0d2f39f`, and **DicomFieldsView** `eefe975` headed PASS (prior chrome not re-scored). **Export DICOM** / `name=export-dicom` — Composer headed proof **in progress**. Full TUTORIALS.md walkthrough is still **not** Pass.
