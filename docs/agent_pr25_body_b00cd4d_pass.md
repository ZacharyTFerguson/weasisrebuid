...
**HEAD:** `b00cd4d` (`Add ImageTool Shutter chrome that blacks an eighth-inset box via ShutterOp.`). **Flip** `004f59d`, **Sharpen** `3844bd4`, **Window** `3091f5e`, **Crop** `f88ec68`, **Brightness** `e9ef165`, **AutoLevels** `18f9802`, and **Mask** `3355cda` headed PASS (prior chrome not re-scored). **Shutter** `b00cd4d` headed PASS. Full TUTORIALS.md walkthrough still **not** Pass. Full TUTORIALS.md walkthrough is still **not** Pass.
