...
/**
 * ViewerHub Launch APIs date filters (weasis.org, not typical IHE). {@code lowerDateTime} = studies
 * <em>older than</em>; {@code upperDateTime} = studies <em>more recent than</em>.
 */
