...
/**
 * ViewerHub {@code GET /display} and {@code GET /display/IHEInvokeImageDisplay}. Not a Felix
 * auto-start bundle; HTTP 302 Location is {@code weasis://}.
 */
public final class ViewerHub {
  ...
  public LaunchResult handle(String path, Map<String, List<String>> query) {
    ...
    try {
      return new LaunchResult(302, WeasisLaunch.weasisUri(parsed, nativeZipUrl), null);
