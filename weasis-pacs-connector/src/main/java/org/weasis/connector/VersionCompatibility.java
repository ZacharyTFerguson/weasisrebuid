...
/**
 * {@code version-compatibility.json}: {@code release-version} → {@code minimal-version} + {@code
 * i18n-version}. Qualifier from User-Agent; unknown uses the documented default.
 */
