...
class AcquireEditorI18nFragmentTest {
  ...
  void fragmentHostMatchesAndNameEndsWithI18n() throws IOException {
    ...
    assertTrue(host != null && host.startsWith("org.weasis.acquire.editor"), host);
  }
  ...
  void germanMessagesAreOnTheClasspath() {
    assertTrue(
        Thread.currentThread()
                ...
                .getResource("org/weasis/acquire/messages_de.properties")
            != null);
  }
}
