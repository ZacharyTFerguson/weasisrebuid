...
class CoreI18nFragmentTest {

  @Test
  void fragmentHostIsWeasisCoreAndNameEndsWithI18n() throws IOException {
    ...
    assertTrue(host != null && host.startsWith("org.weasis.core"), host);
  }
  ...
  void germanMessagesAreOnTheClasspath() {
    assertTrue(
        Thread.currentThread()
                ...
                .getResource("org/weasis/core/messages_de.properties")
            != null);
  }
}
