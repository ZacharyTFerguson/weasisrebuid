...
class Viewer2dI18nFragmentTest {

  @Test
  void fragmentHostIsViewer2dAndNameEndsWithI18n() throws IOException {
    ...
    assertTrue(host != null && host.startsWith("org.weasis.dicom.viewer2d"), host);
  }
  ...
  void germanMessagesAreOnTheClasspath() {
    assertTrue(
        Thread.currentThread()
                ...
                .getResource("org/weasis/dicom/viewer2d/messages_de.properties")
            != null);
  }
}
