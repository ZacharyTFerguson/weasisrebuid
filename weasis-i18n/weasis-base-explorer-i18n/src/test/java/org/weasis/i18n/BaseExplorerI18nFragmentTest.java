...
class BaseExplorerI18nFragmentTest {
  ...
  void fragmentHostMatchesAndNameEndsWithI18n() throws IOException {
    ...
    assertTrue(host != null && host.startsWith("org.weasis.base.explorer"), host);
  }
  ...
  void germanMessagesAreOnTheClasspath() {
    assertTrue(
        Thread.currentThread()
                ...
                .getResource("org/weasis/base/explorer/messages_de.properties")
            != null);
  }
}
