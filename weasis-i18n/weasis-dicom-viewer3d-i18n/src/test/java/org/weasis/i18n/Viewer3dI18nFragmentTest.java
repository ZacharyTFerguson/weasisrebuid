...
class Viewer3dI18nFragmentTest {
  ...
  void fragmentHostMatchesAndNameEndsWithI18n() throws IOException {
    ...
    assertTrue(host != null && host.startsWith("org.weasis.dicom.viewer3d"), host);
  }
  ...
  void germanMessagesAreOnTheClasspath() {
    assertTrue(
        Thread.currentThread()
                ...
                .getResource("org/weasis/dicom/viewer3d/messages_de.properties")
            != null);
  }
}
