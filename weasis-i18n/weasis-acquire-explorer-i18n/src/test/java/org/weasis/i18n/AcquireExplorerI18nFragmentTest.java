...
class AcquireExplorerI18nFragmentTest {
  ...
  void fragmentHostMatchesAndNameEndsWithI18n() throws IOException {
    ...
    assertTrue(host != null && host.startsWith("org.weasis.acquire.explorer"), host);
  }
  ...
  void germanMessagesAreOnTheClasspath() {
    assertTrue(
        Thread.currentThread()
                ...
                .getResource("org/weasis/acquire/explorer/messages_de.properties")
            != null);
  }
}
