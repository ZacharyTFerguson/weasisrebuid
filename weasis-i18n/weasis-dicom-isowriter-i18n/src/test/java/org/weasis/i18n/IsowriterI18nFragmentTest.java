...
class IsowriterI18nFragmentTest {
  ...
  void fragmentHostMatchesAndNameEndsWithI18n() throws IOException {
    ...
    assertTrue(host != null && host.startsWith("org.weasis.dicom.isowriter"), host);
  }
  ...
  void germanMessagesAreOnTheClasspath() {
    assertTrue(
        Thread.currentThread()
                ...
                .getResource("org/weasis/dicom/isowriter/messages_de.properties")
            != null);
  }
}
