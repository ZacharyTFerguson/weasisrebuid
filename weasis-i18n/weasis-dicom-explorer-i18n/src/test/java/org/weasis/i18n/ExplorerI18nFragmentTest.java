...
class ExplorerI18nFragmentTest {

  @Test
  void fragmentHostIsExplorerAndNameEndsWithI18n() throws IOException {
    ...
    assertTrue(host != null && host.startsWith("org.weasis.dicom.explorer"), host);
  }
  ...
  void germanMessagesAreOnTheClasspath() {
    assertTrue(
        Thread.currentThread()
                ...
                .getResource("org/weasis/dicom/explorer/messages_de.properties")
            != null);
  }
}
