...
public class RtDisplayToolFactory implements SeriesViewerFactory, DicomSpecialElementFactory {

  public static final String NAME = "DICOM RT Tools";
  ...
  public DicomSpecialElement buildInstance(DcmMediaReader mediaIO) {
    return new RTElementFactory().buildInstance(mediaIO);
  }

  @Override
  public boolean canReadMimeType(String mimeType) {
    return DicomMime.RT_DICOM.equals(mimeType);
  }

  @Override
  public boolean isViewerCreatedByThisFactory(SeriesViewer<?> viewer) {
    return viewer instanceof RtDisplayTool;
  }
  ...
  public String getClassName() {
    return RtDisplayTool.class.getName();
  }

  @Override
  public String getSeriesMimeType() {
    return DicomMime.RT_DICOM;
  }
