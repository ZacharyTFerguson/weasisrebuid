...
@Component(
    ...
    immediate = true)
public class RtFactory implements SeriesViewerFactory, DicomSpecialElementFactory {

  public static final String NAME = "DICOM RT";
  ...
  public boolean isViewerCreatedByThisFactory(SeriesViewer<?> viewer) {
    return viewer instanceof RtTool;
  }
