...
public class WaveFactory implements SeriesViewerFactory, DicomSpecialElementFactory {
  ...
  public boolean canReadMimeType(String mimeType) {
    return DicomMime.WAVE_DICOM.equals(mimeType);
  }
  ...
  public String getClassName() {
    return WaveContainer.class.getName();
  }
