...
@Component(
    ...
    immediate = true)
public class EcgFactory implements SeriesViewerFactory, DicomSpecialElementFactory {

  public static final String NAME = "DICOM ECG";
  ...
  public boolean canReadMimeType(String mimeType) {
    return DicomMime.ECG_DICOM.equals(mimeType);
  }

  @Override
  public boolean isViewerCreatedByThisFactory(SeriesViewer<?> viewer) {
    return viewer instanceof EcgView;
  }
  ...
  public String getClassName() {
    return EcgView.class.getName();
  }

  @Override
  public String getSeriesMimeType() {
    return DicomMime.ECG_DICOM;
  }
