...
public class AuFactory implements SeriesViewerFactory, DicomSpecialElementFactory {
  ...
  public SeriesViewer<?> createSeriesViewer(Hashtable<String, Object> properties) {
    return new AuContainer();
  }

  @Override
  public DicomSpecialElement buildInstance(DcmMediaReader mediaIO) {
    return new AuElementFactory().buildInstance(mediaIO);
  }

  @Override
  public boolean canReadMimeType(String mimeType) {
    return DicomMime.AU_DICOM.equals(mimeType);
  }
  ...
  public String getClassName() {
    return AuContainer.class.getName();
  }

  @Override
  public String getSeriesMimeType() {
    return DicomMime.AU_DICOM;
  }
