...
public final class SyntheticCtWriter {

  private SyntheticCtWriter() {}

  public static void write(File dest, int size, double level, double window) throws IOException {
